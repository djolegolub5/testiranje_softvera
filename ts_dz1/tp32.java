...
public class tp32 {
    ...
    public void tp32() {
        ...
        fregistration.click();
        WebElement verification = driver.findElement(By.xpath("//*[contains(text(),'Godina studija nije u validnom formatu. Pokusajte ponovo.')]"));
        boolean end = verification.getText().contains("Godina studija nije u validnom formatu. Pokusajte ponovo.");
