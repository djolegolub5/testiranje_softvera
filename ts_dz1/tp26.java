...
public class tp26 {
    ...
    public void tp26() {
        ...
        fregistration.click();
        WebElement verification = driver.findElement(By.xpath("//*[contains(text(),'Telefon nije u validnom formatu. Pokusajte ponovo.')]"));
        boolean end = verification.getText().contains("Telefon nije u validnom formatu. Pokusajte ponovo.");
