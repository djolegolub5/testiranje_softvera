...
public class tp24 {
    ...
    public void tp24() {
        ...
        fregistration.click();
        WebElement verification = driver.findElement(By.xpath("//*[contains(text(),'Unete lozinke se ne poklapaju. Pokusajte ponovo.')]"));
        boolean end = verification.getText().contains("Unete lozinke se ne poklapaju. Pokusajte ponovo.");
